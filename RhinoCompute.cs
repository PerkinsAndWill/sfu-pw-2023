...
namespace Rhino.Compute
{
    public static class ComputeServer
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(AuthToken) && WebAddress.Equals("http://localhost:6500"))
                throw new UnauthorizedAccessException("AuthToken must be set for compute.rhino3d.com");
            ...
            using (StreamReader streamReader = new StreamReader(response.GetResponseStream()))
            {
                ...
                Newtonsoft.Json.Linq.JArray ja = data as Newtonsoft.Json.Linq.JArray;
    ...
    public static class PythonCompute
    {
        ...
        class ArchivableDictionaryResolver : JsonConverter
        {
            ...
            public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
            {
                ...
                DictHelper dh = JsonConvert.DeserializeObject<DictHelper>(encoded);
...
namespace Rhino.Compute
{
    public class GrasshopperObject
    {
        ...
        public GrasshopperObject(object obj, string type)
        {
            this.Data = JsonConvert.SerializeObject(obj, GeometryResolver.Settings);
            this.Type = type;
        }
            ...
            public static JsonSerializerSettings Settings
            {
                get
                {
                    if (_settings == null)
                    {
                        ...
                        FileIO.SerializationOptions options = new Rhino.FileIO.SerializationOptions();
    ...
    public class GrasshopperDataTree
    {
        ...
        public bool Contains(GrasshopperObject item)
        {
            ...
            foreach (List<GrasshopperObject> list in _tree.Values)
            {
