                      ...
                      >
                        ...
                        />
                                    ...
                                    <v-tooltip bottom>
                                        <template #activator="{ on, attrs }">
                                            <v-btn v-bind="attrs"
                                                   :disabled="parametricAnalysisProgress ==-1"
                        style="width: 200px"
                        class="analyze_button text-none"
                        variant="plain"
                        v-on="on"
                        @click="stopParametricAnalysis()"
                      >
                        <span v-show="!showSpinnerParametricAnalysis">Cancel Analysis</span>
                      </v-btn>
                                        </template>
                                        <span>
                                            Cancel the analysis.
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            stopParametricAnalysis() {
                if (window.Interop) {
                    console.log("analysis canceled");
                    window.Interop.stopParametricAnalysis();
                }
            },
